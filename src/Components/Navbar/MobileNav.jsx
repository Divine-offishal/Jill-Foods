...
const MobileNav = () => {
  ...
  return (
    <>
      <div onClick={handleClick} className={` transition-all duration-300 ease-in-out h-20 w-screen flex md:hidden text-primary pt-4 fixed top-0 left-0 z-50 ${windowHeight > 0? 'bg-amber-900': ' bg-amber-900/0' }`}>
